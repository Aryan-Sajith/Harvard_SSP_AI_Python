...
knowledge0 = And(
    ...
    # Tertiary distinction based on problem info(statement validity)
...
knowledge3 = And(
    ...
    Implication(BKnight, And(CKnave, Implication(AKnight, BKnave), Implication(AKnave, Not(BKnave)))),
    Implication(BKnave, Not(And(CKnave, Implication(AKnight, CKnave), Implication(AKnave, Not(CKnave))))),
